...
import com.ibss.ibss.fragment.InactiveListFragment;
import com.ibss.ibss.fragment.ProfileshowFragment;
import com.ibss.ibss.fragment.ShowAllUsersMassageFragment;
...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        reference.child(uId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                } else if (Objects.equals(user1.getStatus(), "Inactive")) {

                    FirebaseAuth.getInstance().signOut();
                    Intent intent = new Intent(DashboardActivity.this, MainActivity.class);
                    startActivity(intent);
                    Toast.makeText(DashboardActivity.this, "User is Inactive", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            else if (id == R.id.inactiveMenu_id) {
                loadFrag(new InactiveListFragment());
            }
            else if (id == R.id.massageMenu_id) {
                loadFrag(new ShowAllUsersMassageFragment());
        ...
        pro_pic =headerView.findViewById(R.id.profilePic_id);
        u_name = headerView.findViewById(R.id.profileName_id);
