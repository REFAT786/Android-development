    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        reference.child(uId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String nm = user1.getName();
                String blood = user1.getBlood();
                String dep = user1.getDepartment();
                String gen = user1.getGender();
                String p_pic = user1.getImageUrl();
                    ...
                    status.setOnClickListener(v -> {
                        ...
                        active.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if(active.isChecked()){
                                    User user1 = new User(userId, em, nm, blood, dep, gen, 0, p_pic);
                        ...
                        inactive.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if(inactive.isChecked()){
                                    User user1 = new User(userId, em, nm, blood, dep, gen, 2, p_pic);
                                    reference.child(userId).setValue(user1);
