...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText titletextid,notetextid;
    private Button time,date,cancelbutton,timeid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notetextid = findViewById(R.id.notetextid);
        ...
        notetextid.setOnClickListener(this);
        timeid.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.submit_button){
            String title = titletextid.getText().toString();
            String note = notetextid.getText().toString();
